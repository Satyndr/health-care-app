                ...
                <View
                  ...
                  style={[
                    styles.notificationBox,
                    {
                      backgroundColor:
                        idx % 2 === 0
                          ? "rgba(210,131,207,0.15)"
                          : "rgba(131,210,207,0.15)",
                    },
                  ]}
                >
                  <Text style={styles.notificationBoxText}>{n.text}</Text>
                </View>
              ))
            )}
            <TouchableOpacity
              style={[
                styles.modalButton,
                { backgroundColor: "#ccc", alignSelf: "flex-end" },
              ]}
